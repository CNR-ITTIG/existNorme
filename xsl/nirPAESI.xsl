...
<xsl:stylesheet version="1.0" xmlns:nir = "http://www.normeinrete.it/nir/2.2" 
   ...
   <html>
        <head>
            <title>Norme In Rete - Exist DEMO</title>
            <link type="text/css" href="css/paesi.css" rel="stylesheet"/>
            <link type="text/css" href="css/nir.css" rel="stylesheet"/>
        </head>
	<body>
	<div id="body">
	<div id="help">
		<span class="help"><a href="../HELP/aiutoricerca.html " title="Aiuto alla ricerca">Aiuto alla ricerca</a></span>
	</div>
		<xsl:choose>
