...
<script type="text/javascript" src="js/styleswitcher.js">&#160;</script>
    ...
    <a href="?doc={$doc}&amp;css=1" title="Stile Normale" >[Style default]</a>
    <a href="?doc={$doc}&amp;css=2" title="Stile Alto contrasto - Bianco/Nero" ><span id="page_head_navi_STYLEBN"><span class="none_tose">[Bianco/Nero]</span></span></a>
    <a href="?doc={$doc}&amp;css=3" title="Stile Alto contrasto - Nero/Bianco" ><span id="page_head_navi_STYLENB"><span class="none_tose">[Nero/Bianco]</span></span></a>
    <a href="?css=2" title="Stile Alternativo - colorato" ><span id="page_head_navi_STYLEC"><span class="none_tose">[Colorato]</span></span></a>
    <a href="?css=4" title="Stile testo Nero" ><span id="page_head_navi_STYLEN"><span class="none_tose">[ testo Nero]</span></span></a>

    <a href="?css=0" title="Solo testo" ><span id="page_head_navi_STYLEST"><span class="none_tose">[Solo testo]</span></span></a>
</div>
				...
				<xsl:choose>
					<xsl:when test="$datafine!=''">
						...
						<p style="font-weight:bold;">
							...
							<xsl:value-of select="concat(substring($datafine,7,2),'/',substring($datafine,5,2),'/',substring($datafine,1,4))"/></p>
						</div>
					</xsl:when>
				</xsl:choose>
					...
					<xsl:when test="$data_fine&lt;number(number($datafine)+1)">
						...
						<xsl:choose>
							<xsl:when test="//*[name()='evento'][@id=$fine_id]/@tipo='inapplicabilita'">
								<div style=" margin: 15px; color:red; font-size: 160%"> LEGGE INEFFICACE </div>
							</xsl:when>
							<xsl:otherwise>
	...
	<xsl:template match="//*[name()='nota']">
		...
		<div class="nota"><xsl:text>&#160;-&#160;</xsl:text></div>
		<xsl:apply-templates />
	</xsl:template>
				...
				<xsl:when test="$data_fine!=''">
					<xsl:choose>
						...
						<xsl:when test="$data_inizio&gt;number(number($datafine)-1)">
							<div style="color:#060;display:inline;">
...
<xsl:attribute name="title"><xsl:copy-of select="$tooltip" /></xsl:attribute> [ ... ] <a href="#n{@id}" name="t{@id}"> <sup>{<xsl:value-of select="substring($ittignota,4,number(string-length($ittignota)))"/>}</sup></a></span>						 								 		
								-->
								<div style="color:#f00;display:inline"> 	
<xsl:attribute name="title"><xsl:copy-of select="$tooltip" /></xsl:attribute>							
								<xsl:choose>
