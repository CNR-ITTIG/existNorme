						...
						<tr>
							<td  align="center" colspan="3">Autorità
								  <select name="autoritaModifica"   class="low" >
					                    <option value=""/>
										<option value="comunita.europee">Comunità Europee</option>
					                    <option value="ministero.beni.culturali.ambientali">Ministero dei Beni Culturali e Ambientali</option>
					                    <option value="ministero.economia.finanze">Ministero Economia e Finanze</option>
					                    <option value="presidente.consiglio.ministri">Presidente del Consiglio dei Ministri</option>
					                    <option value="presidente.repubblica">Presidente della Repubblica</option>
