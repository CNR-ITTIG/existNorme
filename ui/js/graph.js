...
Graph.prototype = {
  initialize: function( frame_width, frame_height ) {
	...
	frame_width = parseInt(frame_width - 200);
  ...
  addNode: function( mass, decreto, anno, numero, urn, queryType) {
	...
	var text =  decreto+":"+anno+":"+numero+":"+urn+":"+queryType;
    this['nodestext'][text] = node;

    try {
      this.ui.addNode(node, decreto, anno, numero, urn, queryType);
    } catch( e ) {
