...
n.&#160;<xsl:value-of select="/*[name()='NIR']/*/*/*[name()='numDoc' and not(@nome) ]"/>
<xsl:if test="/*[name()='NIR']/*/*/*[name()='numDoc' and (@nome) ]">
&#160;(protocollo n.&#160;<xsl:value-of select="/*[name()='NIR']/*/*/*[name()='numDoc' and (@nome) ]"/>)
</xsl:if>
...
<a href="index.xql?panel=search&amp;css={$css}">Cerca Legge</a>
 ...
 <li>
<a href="index.xql?panel=browse&amp;css={$css}">CMS</a>
</li>
...
<div style="font-weight: bold; font-style: normal; text-align: center">
...
&#160;<xsl:text>n.&#160;</xsl:text>
<xsl:apply-templates select="/*[name()='NIR']/*/*/*[name()='numDoc' and not(@nome)]"/>
<xsl:if test="/*[name()='NIR']/*/*/*[name()='numDoc' and @nome]">
(protocollo n. <xsl:apply-templates select="*[name()='numDoc' and @nome]"/>)
</xsl:if>
...
<!--div style="font-weight: bold; font-style: normal; text-align: right">
<xsl:call-template name="urnvigente"/>
</div-->
<hr/>
<xsl:choose>
<xsl:when test="//*[name()='NIR']/@tipo!='originale'">
   ...
   <xsl:for-each select="//*[name()='eventi']/*[@tipo!='allegato']">
